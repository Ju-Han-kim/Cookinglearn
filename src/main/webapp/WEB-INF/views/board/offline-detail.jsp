		...
		<tr>
			<td>
				<p>
					...
					<fmt:formatDate value="${detail.startDate}" pattern="yyyy년 MM월 dd일"/>
				</p>
			</td>
			<td>
				<p>
					<img src="/resources/board/icon/calender.png"> 강의 시간 :
					<fmt:formatDate value="${detail.startDate}" pattern="HH시 mm분"/>
				</p>
			</td>
		</tr>
		<tr>
...
<script type="text/javascript">
	...
	function getCheckedCnt()  {
		  ...
		  // 출력z
		  document.getElementById('reviewStar').innerText = selectedElementsCnt;
	}
