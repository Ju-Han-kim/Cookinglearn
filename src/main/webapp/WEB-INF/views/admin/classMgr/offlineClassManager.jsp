				...
				<div class="col-md-12">
					<div class="card border-secondary mb-3">
						<div class="card-header">
							<strong>오프라인 강의관리</strong> > 
							<a class="btn btn-sm btn-outline-info ${offOption == 1?'active':''}" href="<c:url value='/admin/class/off1' />">예정강의</a> / 
							<a class="btn btn-sm btn-outline-info ${offOption == 2?'active':''}" href="<c:url value='/admin/class/off2' />">완료대기</a> / 
							<a class="btn btn-sm btn-outline-info ${offOption == 3?'active':''}" href="<c:url value='/admin/class/off3' />">완료강의</a>
						</div>
						<div class="card-body text-secondary">
							<div class="form-group row">
								...
								<div class="form-check form-check-inline col-sm-4">&nbsp;
							 	...
							 	<label class="col-sm-1 col-form-label">강의일자</label>
