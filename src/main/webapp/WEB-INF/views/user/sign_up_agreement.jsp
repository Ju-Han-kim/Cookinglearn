...
<html>
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="/resources/css/user/sign_up_agreement.css" />
  </head>
  <!-- jquery -->
  ...
  <body>
    ...
    <div class="sign_up_agreement_title">
      <h2>이용약관</h2>
    </div>
    <div class="sign_up_agreement_form">
      <h4 id="conditions_title">쿠킹런 이용약관 안내</h4>
      <textarea
        spellcheck="false"
        readonly
        name="conditions"
        ...
        cols="55"
        rows="8"
      >쿠킹런 이용약관은 다음과 같은 내용을 담고 있습니다. (2021년 4월 17일 시행)
      제1조(목적)
      이 약관은 전기통신사업법령 및 정보통신망이용촉진, 전자상거래 등에 관한 법령에 의하여 (주)쿠킹런(이하 "회사"라 합니다)가 제공하는 쿠킹런의 서비스(이하 “서비스"라 한다) 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
      제2조(약관의 효력 및 변경)
      (1) 이 약관은 회사가 그 내용을 서비스 초기 화면을 통해 게시하고 이용자가 이에 동의를 함으로써 효력을 발생합니다.
      (2) 회사는 합리적인 사유가 있을 경우 약관규제에 관한 법률, 정보통신망 이용촉진 및 정보보호등에 관한 법률 등 관련법을 위배하지 않는 범위에서 본 약관을 변경할 수 있으며, 이 경우 적용일자 및 개정사유를 명시하여 현행약관과 함께 쿠킹런의 서비스 초기 화면에 그 적용일자 7일이전부터 적용일자 전일까지 공지합니다. 다만, 이용자에게 불리하게 약관내용을 변경하는 경우에는 최소한 30일 이상의 사전 유예기간을 두고 공지합니다.
      ...
      제9조(계약사항의 변경)
      (1) 회원은 개인정보수정을 통해 언제든지 개인정보를 열람하고 수정할 수 있습니다.
      ...
      [부칙]
      1. (시행일) 본 약관은 2021년 4월 17일부터 시행됩니다.
      2. 2020년 9월 14일부터 시행되던 종전의 약관은 본 약관으로 대체됩니다.
      3. 본 약관 시행 전에 이미 가입된 회원은 변경 전의 약관이 적용됨을 원칙으로 합니다. 다만, 공지된 바에 따라 변경된 약관의 시행일 이후에도 본 약관에 따른 서비스를 계속 이용하는 경우에는 변경 후의 약관에 대해 동의한 것으로 봅니다.</textarea
      >
      <h4 id="personal_info_title">개인정보 수집 및 이용에 대한 안내</h4>
      <textarea
        spellcheck="false"
        name="personal_info"
        id="personal_info"
        cols="55"
        rows="8"
      >(주)쿠킹런(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 회사의 서비스를 이용하는 회원(이하 ‘이용자’라 한다) 의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립·공개합니다.
        1. 총칙
        ...
        나) 제휴관계에 변화가 있거나 제휴관계가 종결될 때도 같은 절차에 의하여 고지하거나 동의를 구합니다. 이용자 동의에 의한 이벤트 참여의 경우 이용자가 쿠킹런을 탈퇴 후에도 동의한 이벤트 주최사의 마케팅에 향후 6개월간 활용이 될 수 있습니다.
        ...
        제7조 개인정보의 열람, 정정
        １. 이용자는 언제든지 등록되어 있는 이용자의 개인정보를 열람하거나 정정할 수  있습니다. 개인정보 열람 및 정정을 하고자 할 경우에는 이용자정보수정을 통해 직접 열람 또는 정정하거나, 개인정보관리책임자 및 담당자에게 서면, 전화 또는 E-mail로 요청한 경우 회사는 지체 없이 조치하겠습니다.
        ...
        １. 회원가입 등을 통해 개인정보의 수집, 이용, 제공에 대해 이용자께서 동의하신 내용을 이용자는 언제든지 철회하실 수 있습니다. 동의철회(회원탈퇴)는 홈페이지에 로그인 하신 이용자정보수정에서 회원탈퇴를 통해 직접 하거나 개인정보관리책임자에게 개인정보의 삭제 등 필요한 조치를 요구할 수 있습니다.
        ...
        １. 이용자가 쿠킹런의 이용자로서의 자격을 유지하고 있는 동안에는 이용자가 회사에 제공한 개인정보를 계속 보유합니다.
        ...
        - 전화번호 : 02-323-5002
        - 팩스번호 : 02-323-5049
        - 주 소 : 서울 금천구 가산동 371-50 에이스하이엔드타워 3차 11F
        - 이용자센터 : 사이트 내 고객센터
        ３. 전화상담은 평일 오전 10 : 00 ~ 오후 5 : 00 에만 가능합니다.
        ４. 고객센터 게시판이나 팩스를 이용한 상담은 접수 후 12시간 내에 성실하게 답변 드리겠습니다. 다만, 근무시간 이후 또는 주말 및 공휴일에는 익일 처리하는 것을 원칙으로 합니다.
        ５. 기타 개인정보에 관한 상담이 필요한 경우에는 개인정보침해신고센터로 문의하실 수 있습니다.
        가) 개인정보침해신고센터 (http://privacy.kisa.or.kr / 118)
        나) 정보보호마크인증위원회 (www.eprivacy.or.kr / 02-580-0533~4)
        다) 대검찰청 첨단범죄수사과 (http://www.spo.go.kr / 02-3480-2000)
        라) 경찰청 사이버테러대응센터 (www.ctrc.go.kr / 02-392-0330)
        제17조 정보관리책임자 및 담당자
        １. 이용자가 좋은 정보를 안전하게 이용할 수 있도록 최선을 다하고 있습니다.
        ２. 개인정보를 보호하는데 있어 이용자께 고지한 사항들에 반하는 사고가 발생할 시에 개인정보관리책임자가 모든 책임을 집니다. 그러나 기술적인 보완조치를 했음에도 불구하고, 해킹 등 기본적인 네트워크상의 위험성에 의해 발생하는 예기치 못한 사고로 인한 정보의 훼손 및 방문자가 작성한 게시물에 의한 각종 분쟁에 관해서는 책임이 없습니다. 이용자의 개인정보를 취급하는 책임자 및 담당자는 다음과 같으며 개인정보 관련 문의사항에 신속하고 성실하게 답변해드리고 있습니다.
        가) 개인정보 관리책임자
        - 소속 : 기획팀
        - 성명 : 최준우
        - E-mail : cookinglearn@hotmail.com
        - 전화번호 : 02-323-5002
        - FAX : 02-323-5049
        나) 개인정보 관리담당자
        - 소속 : 기획팀
    ...
    <div class="button_wrap">
      <input
        type="button"
        class="button agree_button"
        value="동의"
      />
      <input
        type="button"
        onclick="location.href='/'"
        class="button disagree_button"
        value="비동의"
      />
    </div>
    <script>
